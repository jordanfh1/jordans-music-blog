...
export default function BlogEntry1() {
  ...
  <p className={styles.date}>31/10/2024</p>
...
<h2 className={styles.h2}>1. The Sound of Sonny by Sonny Rollins (1957)</h2>
  <a className={styles.listenLink} href="https://open.spotify.com/album/7rdwLkz0GnXzoigceU8jwQ?si=rYxs6O12S6WtR9GN7MszDA" target="_blank">Listen here on Spotify!</a>
  ...
  <Image className={styles.image} src="https://upload.wikimedia.org/wikipedia/en/3/3a/The_Sound_of_Sonny.jpg" alt="The Sound of Sonny by Sonny Rollins cover art" width="250" height="250"/>
  </div>
  ...
  <a className={styles.listenLink} href="https://open.spotify.com/album/21I47sl9rvEugaiEIvDVyh?si=tabgj9uDTA-PawtxZVvr_w" target="_blank">Listen here on Spotify!</a>
  ...
  <Image className={styles.image} src="https://upload.wikimedia.org/wikipedia/en/thumb/1/15/Bud_Powell_-_Jazz_Giant_%28album_cover%29.jpg/220px-Bud_Powell_-_Jazz_Giant_%28album_cover%29.jpg" alt="Jazz Giant by Bud Powell cover art" width="250" height="250"/>
  ...
  <a className={styles.listenLink} href="https://open.spotify.com/album/5VDjsnQKRNJyR90or4Tsjw?si=4YTl-iiuSW2-AxNzgfrusg" target="_blank">Listen here on Spotify!</a>
  ...
  <Image className={styles.image} src="https://e.snmc.io/i/600/w/5a5379a5ca516cdd83032a28858931ec/7168189/stan-getz-the-artistry-of-stan-getz-Cover-Art.jpg" alt="Out of the Cool by Gil Evans cover art" width="250" height="250"/>
  </div>
