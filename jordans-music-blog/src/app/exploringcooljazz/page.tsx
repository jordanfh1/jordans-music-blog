...
<h2 className={styles.h2}>1. The Sound of Sonny by Sonny Rollins (1957)</h2>
  <a className={styles.listenLink} href="https://open.spotify.com/album/7rdwLkz0GnXzoigceU8jwQ?si=rYxs6O12S6WtR9GN7MszDA">Listen here on Spotify!</a>
  ...
  <Image className={styles.image} src="https://upload.wikimedia.org/wikipedia/en/3/3a/The_Sound_of_Sonny.jpg" alt="The Sound of Sonny by Sonny Rollins cover art" width="300" height="300"/>
  </div>
